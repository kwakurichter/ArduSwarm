...
![Base Drone](/docs/images/hardware_setup/base-drone.JPG)
...
![Header Slack](/docs/images/hardware_setup/header-slack.JPG)
...
| ![Flow Deck (orientation)](/docs/images/hardware_setup/flow-deck-orientation.JPG) | ![Flow Deck (attached)](/docs/images/hardware_setup/flow-deck-attached.JPG) |
|--------------------------|--------------------------|

Next, take the micro SD card and place it in the SD Card Deck.

| ![SD Card (orientation)](/docs/images/hardware_setup/sd-card-orientation.JPG) | ![SD Card (inserted)](/docs/images/hardware_setup/sd-card-inserted.JPG) |
|--------------------------|--------------------------|
...
![SD Card Deck (orientation)](/docs/images/hardware_setup/sd-card-deck-orientation.JPG)
...
![Crazyflie Schematic (SPI Bus)](/docs/images/hardware_setup/schematic-spi-bus.png)
...
![Header Small Pin](/docs/images/hardware_setup/header-small-pin.JPG)
...
![AI Deck (orientation)](/docs/images/hardware_setup/ai-deck-orientation.JPG)
...
![AI Deck Pin Gap](/docs/images/hardware_setup/ai-deck-pin-gap.JPG)
...
![Final Assembly](/docs/images/hardware_setup/final-assembly.JPG)